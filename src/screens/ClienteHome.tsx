...
import { getUser, UserData } from "../storage/UserStorage"; // Importar getUser
...
export default function ClienteHome({ navigation }: Props) {
  ...
  // Remover referência a unreadMessages que não é mais usado
  ...
  const loadUserData = async () => {
    ...
    try {
      ...
      if (userData) {
        ...
        // Exemplo de lógica para notificação de perfil incompleto
        const isProfileComplete = userData.nome && userData.telefone && userData.endereco && userData.endereco.cep; // Adapte conforme seus campos obrigatórios
