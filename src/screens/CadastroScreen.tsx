...
export default function CadastroScreen({ navigation }: Props) {
  ...
  const handleCadastro = async () => {
    ...
    setLoading(true);
    try {
      console.log('Tentando cadastrar usuário:', { nome: nome.trim(), email: email.toLowerCase().trim(), celular, tipo });
      ...
      Alert.alert(
        "Cadastro realizado!",
        `Conta criada com sucesso! Um e-mail de verificação foi enviado para ${email}. Por favor, verifique sua caixa de entrada e spam, confirme seu e-mail e depois faça login.`,
        [
          {
            text: 'OK',
            onPress: () => {
