  ...
  return (
    ...
    >
      ...
      <Tab.Screen 
        ...
        options={{ 
          tabBarIcon: ({ focused }) => (
            <TabBarIcon focused={focused} name={focused ? 'list' : 'list-outline'} label="Pedidos" />
          ),
        }}
      />
      <Tab.Screen 
        ...
        options={{ 
          tabBarIcon: ({ focused }) => (
            <TabBarIcon focused={focused} name={focused ? 'chatbubble' : 'chatbubble-outline'} label="Mensagens" />
          ),
        }}
      />
      <Tab.Screen 
        ...
        options={{ 
          tabBarIcon: ({ focused }) => (
            <TabBarIcon focused={focused} name={focused ? 'heart' : 'heart-outline'} label="Favoritos" />
          ),
        }}
      />
      <Tab.Screen 
